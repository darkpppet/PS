...
int main()
{
    ...
    constexpr long long seqSize = 1 << 21;
    ...
    vector<long long> a1(seqSize);
    vector<long long> a2(seqSize);
    vector<long long> b1(seqSize);
    vector<long long> b2(seqSize);
    ...
    for (int i = 0; i < seqSize; i++)
    {
        ...
        temp -= temp >= 2478668648395309057LL / 2 ? 2478668648395309057LL : 0LL;
